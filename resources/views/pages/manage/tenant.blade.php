    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidenav" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="unit" class="nav-link text-white">
                        <span>
                ...
                <li>
                    <a href="tenant" class="nav-link active text-white">
                        <span>
                ...
                <hr>
                <li>
                    <a href="rentbills" class="nav-link text-white">
                        <span>
                ...
                <li>
                    <a href="electricbills" class="nav-link text-white">
                        <span>
                ...
                <li>
                    <a href="waterbills" class="nav-link text-white">
                        <span>
                ...
                <tbody>
                    @foreach ($tenants as $tenant)
                        <tr>
                            ...
                            <td>{{ $tenant->rent_id}}</td>
                            <td>{{ $tenant->electric_id }}</td>
                            <td>{{ $tenant->water_id}}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
